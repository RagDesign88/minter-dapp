...
const welcome_h1 = "Welcome to the world of Crack Rabbit!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Crack Rabbit Collective is a project dedicated to the wacky, twisted, and strange cartoons we grew up with. We would have more to say, but 10,000 randomly generated cartoon crack smoking rabbits speaks for itself.';
const h1_presale_coming_soon = "Crack Drop Coming Soon!!";
